...
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(p1__10543_SHARP_),code);
});})(countries))
,countries));
...
tunnelbear.popup.core.log.call(null,new cljs.core.Keyword(null,"DEBUG","DEBUG",-56433076),[cljs.core.str("[Popup] : update state"),cljs.core.str(state)].join(''));

var G__10545_10546 = (((state instanceof cljs.core.Keyword))?state.fqn:null);
switch (G__10545_10546) {
case "OUTOFDATA":
...
tunnelbear.popup.core.add_toggle_animations = (function add_toggle_animations(){
tunnelbear.popup.core.jquery.call(null,".toggle-background").addClass("toggle-transitions");

return tunnelbear.popup.core.jquery.call(null,".toggle-switch").addClass("toggle-transitions");
});
...
tunnelbear.popup.core.add_toggle_animations.call(null);
...
return chrome.commands.getAll((function (p1__10551_SHARP_){
return callback.call(null,cljs.core.js__GT_clj.call(null,p1__10551_SHARP_));
}));
});
...
return tunnelbear.common.ports.send_message.call(null,new cljs.core.Keyword(null,"chrome","chrome",1718738387),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"COMMAND","COMMAND",1767426703),"change-country",new cljs.core.Keyword(null,"PARAM","PARAM",674983027),code], null));
});
...
tunnelbear.popup.core.init_popup_collapsed_state = (function init_popup_collapsed_state(collapsed_QMARK_){
if(cljs.core.truth_(collapsed_QMARK_)){
tunnelbear.popup.core.jquery.call(null,"#map").hide();
} else {
tunnelbear.popup.core.jquery.call(null,"#map").show();
}

return cljs.core.get_in.call(null,cljs.core.deref.call(null,tunnelbear.popup.core.view_model),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"collapseStateInited","collapseStateInited",573283975)], null)).call(null,true);
});
tunnelbear.popup.core.persist_popup_collapsed_state = (function persist_popup_collapsed_state(collapsed_QMARK_){
return tunnelbear.common.utils.storage_set.call(null,"popupCollapsed",collapsed_QMARK_);
});
tunnelbear.popup.core.get_popup_collapsed_state = (function get_popup_collapsed_state(){
return tunnelbear.common.utils.storage_get.call(null,"popupCollapsed",(function (result){
var collapsedResult = new cljs.core.Keyword(null,"popupCollapsed","popupCollapsed",1521775141).cljs$core$IFn$_invoke$arity$1(result);
var collapsed_QMARK_ = !(((collapsedResult == null)) || (cljs.core._EQ_.call(null,collapsedResult,false)));
if(collapsed_QMARK_){
tunnelbear.popup.core.collapse_popup.call(null);
} else {
tunnelbear.popup.core.expand_popup.call(null);
}

return tunnelbear.popup.core.init_popup_collapsed_state.call(null,collapsed_QMARK_);
}));
});
tunnelbear.popup.core.expand_popup = (function expand_popup(){
cljs.core.get_in.call(null,cljs.core.deref.call(null,tunnelbear.popup.core.view_model),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"collapseToggleIcon","collapseToggleIcon",-1615155189)], null)).call(null,tunnelbear.popup.utils.get_icon.call(null,"collapse"));

return cljs.core.get_in.call(null,cljs.core.deref.call(null,tunnelbear.popup.core.view_model),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"isCollapsed","isCollapsed",1387514736)], null)).call(null,false);
});
tunnelbear.popup.core.collapse_popup = (function collapse_popup(){
cljs.core.get_in.call(null,cljs.core.deref.call(null,tunnelbear.popup.core.view_model),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"collapseToggleIcon","collapseToggleIcon",-1615155189)], null)).call(null,tunnelbear.popup.utils.get_icon.call(null,"expand"));

return cljs.core.get_in.call(null,cljs.core.deref.call(null,tunnelbear.popup.core.view_model),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"isCollapsed","isCollapsed",1387514736)], null)).call(null,true);
});
tunnelbear.popup.core.toggle_expand_collapse = (function toggle_expand_collapse(){
var obsIsCollapsed = cljs.core.get_in.call(null,cljs.core.deref.call(null,tunnelbear.popup.core.view_model),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"isCollapsed","isCollapsed",1387514736)], null));
if(cljs.core._EQ_.call(null,obsIsCollapsed.call(null),true)){
tunnelbear.popup.core.expand_popup.call(null);
} else {
tunnelbear.popup.core.collapse_popup.call(null);
}

return tunnelbear.popup.core.persist_popup_collapsed_state.call(null,obsIsCollapsed.call(null));
});
cljs.core.reset_BANG_.call(null,tunnelbear.popup.core.view_model,cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"viewState","viewState",156262881),new cljs.core.Keyword(null,"changeCountry","changeCountry",1128919138),new cljs.core.Keyword(null,"openSettings","openSettings",581735938),new cljs.core.Keyword(null,"permissions","permissions",67803075),new cljs.core.Keyword(null,"closeSettings","closeSettings",-1781151068),new cljs.core.Keyword(null,"viewStateSettings","viewStateSettings",1282191430),new cljs.core.Keyword(null,"closeTwitterPromo","closeTwitterPromo",1131884806),new cljs.core.Keyword(null,"collapseStateInited","collapseStateInited",573283975),new cljs.core.Keyword(null,"isTwitterPromo","isTwitterPromo",-298812952),new cljs.core.Keyword(null,"openExtensions","openExtensions",591160136),new cljs.core.Keyword(null,"tweetNow","tweetNow",428374281),new cljs.core.Keyword(null,"toggleText","toggleText",-252487414),new cljs.core.Keyword(null,"isLoaded","isLoaded",-1407824598),new cljs.core.Keyword(null,"collapseToggleIcon","collapseToggleIcon",-1615155189),new cljs.core.Keyword(null,"prefFeedback","prefFeedback",1239030763),new cljs.core.Keyword(null,"isToggled","isToggled",724650957),new cljs.core.Keyword(null,"openCountry","openCountry",1017611310),new cljs.core.Keyword(null,"toggle","toggle",1291842030),new cljs.core.Keyword(null,"countries","countries",863192750),new cljs.core.Keyword(null,"updateAccount","updateAccount",-116715762),new cljs.core.Keyword(null,"dataCap","dataCap",-249970833),new cljs.core.Keyword(null,"selectedCountry","selectedCountry",1452370384),new cljs.core.Keyword(null,"prefKeyboard","prefKeyboard",-2130373808),new cljs.core.Keyword(null,"isCollapsed","isCollapsed",1387514736),new cljs.core.Keyword(null,"reviewText","reviewText",1362230641),new cljs.core.Keyword(null,"isEmailConfirmed","isEmailConfirmed",-105522383),new cljs.core.Keyword(null,"prefReview","prefReview",-1829523662),new cljs.core.Keyword(null,"currentMonth","currentMonth",294875059),new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"prefHelp","prefHelp",-2080705418),new cljs.core.Keyword(null,"prefPrivacy","prefPrivacy",-1384066730),new cljs.core.Keyword(null,"prefCloseKeyboard","prefCloseKeyboard",-1485430761),new cljs.core.Keyword(null,"reviewVM","reviewVM",308146936),new cljs.core.Keyword(null,"prefLogout","prefLogout",-1975663590),new cljs.core.Keyword(null,"closeCountry","closeCountry",-1583618598),new cljs.core.Keyword(null,"prefOpenAccount","prefOpenAccount",-2085818854),new cljs.core.Keyword(null,"isFullVersion","isFullVersion",-1967222371),new cljs.core.Keyword(null,"dataAllowed","dataAllowed",1188901502),new cljs.core.Keyword(null,"toggleExpandCollapse","toggleExpandCollapse",1797473759)],[tunnelbear.popup.utils.observable.call(null,new cljs.core.Keyword(null,"NORMAL","NORMAL",438371611)),tunnelbear.popup.core.change_country,tunnelbear.popup.core.open_settings,tunnelbear.popup.utils.observable.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"error","error",-978969032),false,new cljs.core.Keyword(null,"details","details",1956795411),""], null)),tunnelbear.popup.core.close_settings,tunnelbear.popup.utils.observable.call(null,new cljs.core.Keyword(null,"NONE","NONE",555544038)),tunnelbear.popup.core.close_twitter,tunnelbear.popup.utils.observable.call(null,false),tunnelbear.popup.utils.observable.call(null,false),tunnelbear.popup.core.open_extensions,tunnelbear.popup.core.tweet_now,tunnelbear.popup.utils.observable.call(null,"OFF"),tunnelbear.popup.utils.observable.call(null,false),tunnelbear.popup.utils.observable.call(null,tunnelbear.popup.utils.get_icon.call(null,"expand")),tunnelbear.popup.core.open_feedback,tunnelbear.popup.utils.observable.call(null,false),tunnelbear.popup.core.open_country,tunnelbear.popup.core.toggle,tunnelbear.popup.utils.observable.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"code","code",1586293142),(0),new cljs.core.Keyword(null,"iso","iso",-1366207543),"US",new cljs.core.Keyword(null,"lat","lat",-580793929),(37),new cljs.core.Keyword(null,"lon","lon",522068437),-95.7,new cljs.core.Keyword(null,"enabled","enabled",1195909756),true,new cljs.core.Keyword(null,"paidOnly","paidOnly",-1892879818),false], null)], null)),tunnelbear.popup.core.update_account,tunnelbear.popup.utils.observable.call(null,(0)),tunnelbear.popup.utils.observable.call(null,new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"code","code",1586293142),(0),new cljs.core.Keyword(null,"iso","iso",-1366207543),"US",new cljs.core.Keyword(null,"lat","lat",-580793929),(37),new cljs.core.Keyword(null,"lon","lon",522068437),-95.7,new cljs.core.Keyword(null,"enabled","enabled",1195909756),true,new cljs.core.Keyword(null,"paidOnly","paidOnly",-1892879818),false], null)),tunnelbear.popup.core.open_keyboard,tunnelbear.popup.utils.observable.call(null,true),[cljs.core.str("Review on "),cljs.core.str(tunnelbear.common.utils.get_browser_title),cljs.core.str(" Store")].join(''),tunnelbear.popup.utils.observable.call(null,true),tunnelbear.popup.core.open_review,tunnelbear.common.utils.months.call(null,(new Date()).getMonth()),tunnelbear.popup.utils.observable.call(null,"Disconnected"),tunnelbear.popup.core.open_help,tunnelbear.popup.core.open_privacy,tunnelbear.popup.core.close_keyboard,cljs.core.deref.call(null,tunnelbear.popup.review.view_model),tunnelbear.popup.core.log_out,tunnelbear.popup.core.close_country,tunnelbear.popup.core.open_account,tunnelbear.popup.utils.observable.call(null,true),tunnelbear.popup.utils.observable.call(null,(100)),tunnelbear.popup.core.toggle_expand_collapse]));
...
tunnelbear.popup.core.get_popup_collapsed_state.call(null);
