...
var G__34268 = string;
var G__34268__$1 = (((G__34268 == null))?null:[cljs.core.str(G__34268)].join(''));
var G__34268__$2 = (((G__34268__$1 == null))?null:encodeURIComponent(G__34268__$1));
var G__34268__$3 = (((G__34268__$2 == null))?null:G__34268__$2.replace("+","%20"));
return G__34268__$3;
});
cemerick.url.url_decode = (function url_decode(string){
var G__34270 = string;
var G__34270__$1 = (((G__34270 == null))?null:[cljs.core.str(G__34270)].join(''));
var G__34270__$2 = (((G__34270__$1 == null))?null:decodeURIComponent(G__34270__$1));
return G__34270__$2;
});
cemerick.url.map__GT_query = (function map__GT_query(m){
var G__34274 = cljs.core.seq.call(null,m);
var G__34274__$1 = (((G__34274 == null))?null:cljs.core.sort.call(null,G__34274));
var G__34274__$2 = (((G__34274__$1 == null))?null:cljs.core.map.call(null,((function (G__34274,G__34274__$1){
return (function (p__34275){
var vec__34276 = p__34275;
var k = cljs.core.nth.call(null,vec__34276,(0),null);
var v = cljs.core.nth.call(null,vec__34276,(1),null);
...
});})(G__34274,G__34274__$1))
,G__34274__$1));
var G__34274__$3 = (((G__34274__$2 == null))?null:cljs.core.interpose.call(null,"&",G__34274__$2));
var G__34274__$4 = (((G__34274__$3 == null))?null:cljs.core.flatten.call(null,G__34274__$3));
var G__34274__$5 = (((G__34274__$4 == null))?null:cljs.core.apply.call(null,cljs.core.str,G__34274__$4));
return G__34274__$5;
});
...
var G__34278 = clojure.string.split.call(null,qstr,/&/);
var G__34278__$1 = (((G__34278 == null))?null:cljs.core.seq.call(null,G__34278));
var G__34278__$2 = (((G__34278__$1 == null))?null:cljs.core.mapcat.call(null,cemerick.url.split_param,G__34278__$1));
var G__34278__$3 = (((G__34278__$2 == null))?null:cljs.core.map.call(null,cemerick.url.url_decode,G__34278__$2));
var G__34278__$4 = (((G__34278__$3 == null))?null:cljs.core.apply.call(null,cljs.core.hash_map,G__34278__$3));
return G__34278__$4;
} else {
return null;
}
...
cemerick.url.URL.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4586__auto__,k34280,else__4587__auto__){
var self__ = this;
var this__4586__auto____$1 = this;
var G__34282 = (((k34280 instanceof cljs.core.Keyword))?k34280.fqn:null);
switch (G__34282) {
case "anchor":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k34280,else__4587__auto__);
...
cemerick.url.URL.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4591__auto__,k__4592__auto__,G__34279){
var self__ = this;
var this__4591__auto____$1 = this;
var pred__34283 = cljs.core.keyword_identical_QMARK_;
var expr__34284 = k__4592__auto__;
if(cljs.core.truth_(pred__34283.call(null,new cljs.core.Keyword(null,"protocol","protocol",652470118),expr__34284))){
return (new cemerick.url.URL(G__34279,self__.username,self__.password,self__.host,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__34283.call(null,new cljs.core.Keyword(null,"username","username",1605666410),expr__34284))){
return (new cemerick.url.URL(self__.protocol,G__34279,self__.password,self__.host,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__34283.call(null,new cljs.core.Keyword(null,"password","password",417022471),expr__34284))){
return (new cemerick.url.URL(self__.protocol,self__.username,G__34279,self__.host,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__34283.call(null,new cljs.core.Keyword(null,"host","host",-1558485167),expr__34284))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,G__34279,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__34283.call(null,new cljs.core.Keyword(null,"port","port",1534937262),expr__34284))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,G__34279,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__34283.call(null,new cljs.core.Keyword(null,"path","path",-188191168),expr__34284))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,G__34279,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__34283.call(null,new cljs.core.Keyword(null,"query","query",-1288509510),expr__34284))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,self__.path,G__34279,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__34283.call(null,new cljs.core.Keyword(null,"anchor","anchor",1549638489),expr__34284))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,self__.path,self__.query,G__34279,self__.__meta,self__.__extmap,null));
} else {
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4592__auto__,G__34279),null));
}
}
}
}
...
cemerick.url.URL.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4583__auto__,G__34279){
var self__ = this;
var this__4583__auto____$1 = this;
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,self__.path,self__.query,self__.anchor,G__34279,self__.__extmap,self__.__hash));
});
...
cemerick.url.map__GT_URL = (function map__GT_URL(G__34281){
return (new cemerick.url.URL(new cljs.core.Keyword(null,"protocol","protocol",652470118).cljs$core$IFn$_invoke$arity$1(G__34281),new cljs.core.Keyword(null,"username","username",1605666410).cljs$core$IFn$_invoke$arity$1(G__34281),new cljs.core.Keyword(null,"password","password",417022471).cljs$core$IFn$_invoke$arity$1(G__34281),new cljs.core.Keyword(null,"host","host",-1558485167).cljs$core$IFn$_invoke$arity$1(G__34281),new cljs.core.Keyword(null,"port","port",1534937262).cljs$core$IFn$_invoke$arity$1(G__34281),new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(G__34281),new cljs.core.Keyword(null,"query","query",-1288509510).cljs$core$IFn$_invoke$arity$1(G__34281),new cljs.core.Keyword(null,"anchor","anchor",1549638489).cljs$core$IFn$_invoke$arity$1(G__34281),null,cljs.core.dissoc.call(null,G__34281,new cljs.core.Keyword(null,"protocol","protocol",652470118),new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471),new cljs.core.Keyword(null,"host","host",-1558485167),new cljs.core.Keyword(null,"port","port",1534937262),new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.Keyword(null,"query","query",-1288509510),new cljs.core.Keyword(null,"anchor","anchor",1549638489)),null));
});
...
var vec__34288 = clojure.string.split.call(null,(function (){var or__3981__auto__ = url__$1.getUserInfo();
...
var user = cljs.core.nth.call(null,vec__34288,(0),null);
var pass = cljs.core.nth.call(null,vec__34288,(1),null);
...
var url__2 = (function() { 
var G__34289__delegate = function (base_url,path_segments){
...
var G__34289 = function (base_url,var_args){
var path_segments = null;
if (arguments.length > 1) {
var G__34290__i = 0, G__34290__a = new Array(arguments.length -  1);
while (G__34290__i < G__34290__a.length) {G__34290__a[G__34290__i] = arguments[G__34290__i + 1]; ++G__34290__i;}
  path_segments = new cljs.core.IndexedSeq(G__34290__a,0);
} 
return G__34289__delegate.call(this,base_url,path_segments);};
G__34289.cljs$lang$maxFixedArity = 1;
G__34289.cljs$lang$applyTo = (function (arglist__34291){
var base_url = cljs.core.first(arglist__34291);
var path_segments = cljs.core.rest(arglist__34291);
return G__34289__delegate(base_url,path_segments);
});
...
var G__34292 = null;
if (arguments.length > 1) {
var G__34293__i = 0, G__34293__a = new Array(arguments.length -  1);
while (G__34293__i < G__34293__a.length) {G__34293__a[G__34293__i] = arguments[G__34293__i + 1]; ++G__34293__i;}
G__34292 = new cljs.core.IndexedSeq(G__34293__a,0);
}
return url__2.cljs$core$IFn$_invoke$arity$variadic(base_url, G__34292);
}
