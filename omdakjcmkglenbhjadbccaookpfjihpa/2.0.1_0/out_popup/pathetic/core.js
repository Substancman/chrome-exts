...
return cljs.core.map.call(null,cljs.core.first,cljs.core.take_while.call(null,(function (p1__20485_SHARP_){
return cljs.core._EQ_.call(null,cljs.core.first.call(null,p1__20485_SHARP_),cljs.core.second.call(null,p1__20485_SHARP_));
}),cljs.core.map.call(null,(function (p1__20486_SHARP_,p2__20487_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__20486_SHARP_,p2__20487_SHARP_],null));
}),coll1,coll2)));
});
/**
...
var G__20489 = cljs.core.first.call(null,path_pieces);
switch (G__20489) {
case "":
...
var G__20492 = (((cljs.core.first.call(null,path_pieces) instanceof cljs.core.Keyword))?cljs.core.first.call(null,path_pieces).fqn:null);
switch (G__20492) {
case "cwd":
...
var G__20495 = cljs.core.last.call(null,path_pieces);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"root","root",-448657453),G__20495)){
return path_pieces;
} else {
if(cljs.core._EQ_.call(null,"..",G__20495)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"cwd","cwd",14056523),G__20495)){
return cljs.core.conj.call(null,path_pieces,"..");
} else {
...
while(true){
var vec__20500 = remaining_path;
var curr = cljs.core.nth.call(null,vec__20500,(0),null);
var remainder = cljs.core.nthnext.call(null,vec__20500,(1));
var pred__20501 = cljs.core._EQ_;
var expr__20502 = curr;
if(cljs.core.truth_(pred__20501.call(null,null,expr__20502))){
return result;
} else {
if(cljs.core.truth_(pred__20501.call(null,"",expr__20502))){
var G__20504 = result;
var G__20505 = remainder;
result = G__20504;
remaining_path = G__20505;
continue;
} else {
if(cljs.core.truth_(pred__20501.call(null,".",expr__20502))){
var G__20506 = result;
var G__20507 = remainder;
result = G__20506;
remaining_path = G__20507;
continue;
} else {
if(cljs.core.truth_(pred__20501.call(null,"..",expr__20502))){
var G__20508 = pathetic.core.up_dir.call(null,result);
var G__20509 = remainder;
result = G__20508;
remaining_path = G__20509;
continue;
} else {
var G__20510 = cljs.core.conj.call(null,result,curr);
var G__20511 = remainder;
result = G__20510;
remaining_path = G__20511;
continue;
}
}
}
...
var pred__20515 = cljs.core._EQ_;
var expr__20516 = curr;
if(cljs.core.truth_(pred__20515.call(null,null,expr__20516))){
return suffix;
} else {
if(cljs.core.truth_(pred__20515.call(null,"",expr__20516))){
var G__20518 = suffix;
var G__20519 = cljs.core.rest.call(null,remainder);
suffix = G__20518;
remainder = G__20519;
continue;
} else {
if(cljs.core.truth_(pred__20515.call(null,".",expr__20516))){
var G__20520 = suffix;
var G__20521 = cljs.core.rest.call(null,remainder);
suffix = G__20520;
remainder = G__20521;
continue;
} else {
if(cljs.core.truth_(pred__20515.call(null,"..",expr__20516))){
var G__20522 = cljs.core.conj.call(null,suffix,"..");
var G__20523 = cljs.core.rest.call(null,remainder);
suffix = G__20522;
remainder = G__20523;
continue;
} else {
var G__20524 = cljs.core.conj.call(null,suffix,curr);
var G__20525 = cljs.core.rest.call(null,remainder);
suffix = G__20524;
remainder = G__20525;
continue;
}
...
var vec__20527 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__20527,(0),null);
var path = cljs.core.nth.call(null,vec__20527,(1),null);
var post_path = cljs.core.nth.call(null,vec__20527,(2),null);
...
var vec__20529 = pathetic.core.split_url_on_path.call(null,url_or_string);
var pre_path = cljs.core.nth.call(null,vec__20529,(0),null);
var path = cljs.core.nth.call(null,vec__20529,(1),null);
var post_path = cljs.core.nth.call(null,vec__20529,(2),null);
