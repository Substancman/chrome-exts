...
return cljs.core.map.call(null,(function (p1__24316_SHARP_){
return new cljs.core.Keyword(null,"host","host",-1558485167).cljs$core$IFn$_invoke$arity$1(p1__24316_SHARP_);
...
return cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(p1__24317_SHARP_),tunnelbear.background.core.get_country.call(null));
...
var G__24320 = (((port_name instanceof cljs.core.Keyword))?port_name.fqn:null);
switch (G__24320) {
case "settings":
var G__24321 = msg;
switch (G__24321) {
...
return tunnelbear.background.browser.logout.call(null);
...
return tunnelbear.background.api.register.call(null,false,tunnelbear.background.core.get_country.call(null),((function (G__24320){
return (function (){
tunnelbear.common.ports.send_message.call(null,new cljs.core.Keyword(null,"register","register",1968522516),cljs.core.deref.call(null,tunnelbear.background.api.reg_response));
...
break;
case "app-state":
return tunnelbear.background.core.eval_proxy.call(null,((function (G__24320){
...
tunnelbear.background.core.change_app_state_country = (function change_app_state_country(country){
...
tunnelbear.background.core.change_app_state_country.call(null,country);
...
return tunnelbear.background.browser.reset_proxy.call(null);
});
...
cljs.core.swap_BANG_.call(null,tunnelbear.background.core.app_state,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggled","toggled",1679391819)], null),(function (p1__24324_SHARP_){
return cljs.core.not.call(null,p1__24324_SHARP_);
}));
...
if(cljs.core._EQ_.call(null,cljs.core.get_in.call(null,cljs.core.deref.call(null,tunnelbear.background.core.app_state),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggled","toggled",1679391819)], null)),true)){
tunnelbear.background.core.log.call(null,new cljs.core.Keyword(null,"DEBUG","DEBUG",-56433076),"[Background - Core] test call triggered");
...
var toggled_QMARK__24325 = cljs.core.get_in.call(null,cljs.core.deref.call(null,tunnelbear.background.core.app_state),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggled","toggled",1679391819)], null));
if(cljs.core._EQ_.call(null,true,toggled_QMARK__24325)){
...
tunnelbear.background.browser.initialize_pac_script.call(null);
tunnelbear.background.browser.register_listeners.call(null,tunnelbear.background.core.toggle_all,tunnelbear.background.core.toggle_country_param,tunnelbear.background.core.disconnect_proxy);
