...
tunnelbear.common.utils.get_browser = ((((navigator.userAgent.indexOf("OPR") >= (0))) || ((navigator.userAgent.indexOf("Opera") >= (0))))?new cljs.core.Keyword(null,"OPERA","OPERA",802242835):(((navigator.userAgent.indexOf("Firefox") >= (0)))?new cljs.core.Keyword(null,"FIREFOX","FIREFOX",-1393123879):new cljs.core.Keyword(null,"CHROME","CHROME",-160225757)
));
tunnelbear.common.utils.get_browser_title = (function (){var G__21228 = (((tunnelbear.common.utils.get_browser instanceof cljs.core.Keyword))?tunnelbear.common.utils.get_browser.fqn:null);
switch (G__21228) {
case "CHROME":
return "Chrome";
...
tunnelbear.common.utils.test_call = (function test_call(){
return tunnelbear.common.ajax_helper.get.call(null,"https://tunnelbear.com/core/status");
});
