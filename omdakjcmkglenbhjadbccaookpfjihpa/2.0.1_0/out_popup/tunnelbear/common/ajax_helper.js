...
var call_occurences = cljs.core.count.call(null,cljs.core.filter.call(null,(function (p1__6365_SHARP_){
return tunnelbear.common.ajax_helper.is_recent_call_QMARK_.call(null,p1__6365_SHARP_,call);
...
var headers_6366 = cljs.core.js__GT_clj.call(null,response.getResponseHeaders());
var token_6367 = cljs.core.get.call(null,headers_6366,"TB-CSRF-Token");
tunnelbear.common.ajax_helper.log.call(null,new cljs.core.Keyword(null,"DEBUG","DEBUG",-56433076),[cljs.core.str("fetched CSRF token is "),cljs.core.str(token_6367)].join(''));

cljs.core.reset_BANG_.call(null,tunnelbear.common.ajax_helper.csrf_token,token_6367);

return response;
});
tunnelbear.common.ajax_helper.csrf_interceptor = ajax.core.to_interceptor.call(null,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"name","name",1843675177),"CSRF Interceptor",new cljs.core.Keyword(null,"request","request",1772954723),(function (p1__6368_SHARP_){
return cljs.core.assoc_in.call(null,p1__6368_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"headers","headers",-835030129),"TB-CSRF-Token"], null),cljs.core.deref.call(null,tunnelbear.common.ajax_helper.csrf_token));
