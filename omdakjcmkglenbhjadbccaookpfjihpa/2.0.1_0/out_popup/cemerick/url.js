...
var G__20457 = string;
var G__20457__$1 = (((G__20457 == null))?null:[cljs.core.str(G__20457)].join(''));
var G__20457__$2 = (((G__20457__$1 == null))?null:encodeURIComponent(G__20457__$1));
var G__20457__$3 = (((G__20457__$2 == null))?null:G__20457__$2.replace("+","%20"));
return G__20457__$3;
});
cemerick.url.url_decode = (function url_decode(string){
var G__20459 = string;
var G__20459__$1 = (((G__20459 == null))?null:[cljs.core.str(G__20459)].join(''));
var G__20459__$2 = (((G__20459__$1 == null))?null:decodeURIComponent(G__20459__$1));
return G__20459__$2;
});
cemerick.url.map__GT_query = (function map__GT_query(m){
var G__20463 = cljs.core.seq.call(null,m);
var G__20463__$1 = (((G__20463 == null))?null:cljs.core.sort.call(null,G__20463));
var G__20463__$2 = (((G__20463__$1 == null))?null:cljs.core.map.call(null,((function (G__20463,G__20463__$1){
return (function (p__20464){
var vec__20465 = p__20464;
var k = cljs.core.nth.call(null,vec__20465,(0),null);
var v = cljs.core.nth.call(null,vec__20465,(1),null);
...
});})(G__20463,G__20463__$1))
,G__20463__$1));
var G__20463__$3 = (((G__20463__$2 == null))?null:cljs.core.interpose.call(null,"&",G__20463__$2));
var G__20463__$4 = (((G__20463__$3 == null))?null:cljs.core.flatten.call(null,G__20463__$3));
var G__20463__$5 = (((G__20463__$4 == null))?null:cljs.core.apply.call(null,cljs.core.str,G__20463__$4));
return G__20463__$5;
});
...
var G__20467 = clojure.string.split.call(null,qstr,/&/);
var G__20467__$1 = (((G__20467 == null))?null:cljs.core.seq.call(null,G__20467));
var G__20467__$2 = (((G__20467__$1 == null))?null:cljs.core.mapcat.call(null,cemerick.url.split_param,G__20467__$1));
var G__20467__$3 = (((G__20467__$2 == null))?null:cljs.core.map.call(null,cemerick.url.url_decode,G__20467__$2));
var G__20467__$4 = (((G__20467__$3 == null))?null:cljs.core.apply.call(null,cljs.core.hash_map,G__20467__$3));
return G__20467__$4;
} else {
return null;
}
...
cemerick.url.URL.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4586__auto__,k20469,else__4587__auto__){
var self__ = this;
var this__4586__auto____$1 = this;
var G__20471 = (((k20469 instanceof cljs.core.Keyword))?k20469.fqn:null);
switch (G__20471) {
case "anchor":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k20469,else__4587__auto__);
...
cemerick.url.URL.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4591__auto__,k__4592__auto__,G__20468){
var self__ = this;
var this__4591__auto____$1 = this;
var pred__20472 = cljs.core.keyword_identical_QMARK_;
var expr__20473 = k__4592__auto__;
if(cljs.core.truth_(pred__20472.call(null,new cljs.core.Keyword(null,"protocol","protocol",652470118),expr__20473))){
return (new cemerick.url.URL(G__20468,self__.username,self__.password,self__.host,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20472.call(null,new cljs.core.Keyword(null,"username","username",1605666410),expr__20473))){
return (new cemerick.url.URL(self__.protocol,G__20468,self__.password,self__.host,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20472.call(null,new cljs.core.Keyword(null,"password","password",417022471),expr__20473))){
return (new cemerick.url.URL(self__.protocol,self__.username,G__20468,self__.host,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20472.call(null,new cljs.core.Keyword(null,"host","host",-1558485167),expr__20473))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,G__20468,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20472.call(null,new cljs.core.Keyword(null,"port","port",1534937262),expr__20473))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,G__20468,self__.path,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20472.call(null,new cljs.core.Keyword(null,"path","path",-188191168),expr__20473))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,G__20468,self__.query,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20472.call(null,new cljs.core.Keyword(null,"query","query",-1288509510),expr__20473))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,self__.path,G__20468,self__.anchor,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__20472.call(null,new cljs.core.Keyword(null,"anchor","anchor",1549638489),expr__20473))){
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,self__.path,self__.query,G__20468,self__.__meta,self__.__extmap,null));
} else {
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,self__.path,self__.query,self__.anchor,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4592__auto__,G__20468),null));
}
}
}
}
...
cemerick.url.URL.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4583__auto__,G__20468){
var self__ = this;
var this__4583__auto____$1 = this;
return (new cemerick.url.URL(self__.protocol,self__.username,self__.password,self__.host,self__.port,self__.path,self__.query,self__.anchor,G__20468,self__.__extmap,self__.__hash));
});
...
cemerick.url.map__GT_URL = (function map__GT_URL(G__20470){
return (new cemerick.url.URL(new cljs.core.Keyword(null,"protocol","protocol",652470118).cljs$core$IFn$_invoke$arity$1(G__20470),new cljs.core.Keyword(null,"username","username",1605666410).cljs$core$IFn$_invoke$arity$1(G__20470),new cljs.core.Keyword(null,"password","password",417022471).cljs$core$IFn$_invoke$arity$1(G__20470),new cljs.core.Keyword(null,"host","host",-1558485167).cljs$core$IFn$_invoke$arity$1(G__20470),new cljs.core.Keyword(null,"port","port",1534937262).cljs$core$IFn$_invoke$arity$1(G__20470),new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(G__20470),new cljs.core.Keyword(null,"query","query",-1288509510).cljs$core$IFn$_invoke$arity$1(G__20470),new cljs.core.Keyword(null,"anchor","anchor",1549638489).cljs$core$IFn$_invoke$arity$1(G__20470),null,cljs.core.dissoc.call(null,G__20470,new cljs.core.Keyword(null,"protocol","protocol",652470118),new cljs.core.Keyword(null,"username","username",1605666410),new cljs.core.Keyword(null,"password","password",417022471),new cljs.core.Keyword(null,"host","host",-1558485167),new cljs.core.Keyword(null,"port","port",1534937262),new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.Keyword(null,"query","query",-1288509510),new cljs.core.Keyword(null,"anchor","anchor",1549638489)),null));
});
...
var vec__20477 = clojure.string.split.call(null,(function (){var or__3981__auto__ = url__$1.getUserInfo();
...
var user = cljs.core.nth.call(null,vec__20477,(0),null);
var pass = cljs.core.nth.call(null,vec__20477,(1),null);
...
var url__2 = (function() { 
var G__20478__delegate = function (base_url,path_segments){
...
var G__20478 = function (base_url,var_args){
var path_segments = null;
if (arguments.length > 1) {
var G__20479__i = 0, G__20479__a = new Array(arguments.length -  1);
while (G__20479__i < G__20479__a.length) {G__20479__a[G__20479__i] = arguments[G__20479__i + 1]; ++G__20479__i;}
  path_segments = new cljs.core.IndexedSeq(G__20479__a,0);
} 
return G__20478__delegate.call(this,base_url,path_segments);};
G__20478.cljs$lang$maxFixedArity = 1;
G__20478.cljs$lang$applyTo = (function (arglist__20480){
var base_url = cljs.core.first(arglist__20480);
var path_segments = cljs.core.rest(arglist__20480);
return G__20478__delegate(base_url,path_segments);
});
...
var G__20481 = null;
if (arguments.length > 1) {
var G__20482__i = 0, G__20482__a = new Array(arguments.length -  1);
while (G__20482__i < G__20482__a.length) {G__20482__a[G__20482__i] = arguments[G__20482__i + 1]; ++G__20482__i;}
G__20481 = new cljs.core.IndexedSeq(G__20482__a,0);
}
return url__2.cljs$core$IFn$_invoke$arity$variadic(base_url, G__20481);
}
