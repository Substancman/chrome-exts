...
a.setMinutes(a.getMinutes()+d);return a}function Da(a){a=C(a).clone();try{a.empty()}catch(d){}var b=C("<div>").append(a).html();try{return a[0].nodeType===Qa?S(b):b.match(/^(<[^>]+>)/)[1].replace(/^<([\w-]+)/,function(a,b){return"<"+S(b)})}catch(d){return S(b)}}function Xc(a){try{return decodeURIComponent(a)}catch(b){}}function Yc(a){var b={};q((a||"").split("&"),function(a){if(a){var c=a=a.replace(/\+/g,"%20");var d=a.indexOf("=");if(-1!==d){c=a.substring(0,d);var f=a.substring(d+1)}c=Xc(c);u(c)&&
...
function Zc(a,b,d){H(d)||(d={});d=T({strictDi:!1},d);var c=function(){a=C(a);if(a.injector()){var c=a[0]===G.document?"document":Da(a);throw Ca("btstrpd",c.replace(/</,"&lt;").replace(/>/,"&gt;"));}b=b||[];b.unshift(["$provide",function(b){b.value("$rootElement",a)}]);d.debugInfoEnabled&&b.push(["$compileProvider",function(a){a.debugInfoEnabled(!0)}]);b.unshift("ng");c=hb(b,d.strictDi);c.invoke(["$rootScope","$rootElement","$compile","$injector",function(a,b,c,d){a.$apply(function(){b.data("$injector",
...
eb(e,a):a}function yb(a){for(var b=a[0],d=a[a.length-1],c,e=1;b!==d&&(b=b.nextSibling);e++)if(c||a[e]!==b)c||(c=C(za.call(a,0,e))),c.push(b);return c||a}function V(){return Object.create(null)}function fc(a){if(null==a)return"";switch(typeof a){case "string":break;case "number":a=""+a;break;default:a=!bc(a)||K(a)||da(a)?fb(a):a.toString()}return a}function De(a){function b(a,b,c){return a[b]||(a[b]=c())}var d=R("$injector"),c=R("ng");a=b(a,"angular",Object);a.$$minErr=a.$$minErr||R;return b(a,"module",
...
G.document;var d;a=(d=He.exec(a))?[b.createElement(d[1])]:(d=bd(a,b))?d.childNodes:[];jc(this,a)}else z(a)?cd(a):jc(this,a)}function kc(a){return a.cloneNode(!0)}function zb(a,b){!b&&gc(a)&&C.cleanData([a]);a.querySelectorAll&&C.cleanData(a.querySelectorAll("*"))}function dd(a,b,d,c){if(u(c))throw ic("offargs");var e=(c=Ab(a))&&c.events,f=c&&c.handle;if(f)if(b){var g=function(b){var c=e[b];u(d)&&cb(c||[],d);u(d)&&c&&0<c.length||(a.removeEventListener(b,f),delete e[b])};q(b.split(" "),function(a){g(a);
...
U(a);-1===d.indexOf(" "+a+" ")&&(d+=a+" ")});a.setAttribute("class",U(d))}}function jc(a,b){if(b)if(b.nodeType)a[a.length++]=b;else{var d=b.length;if("number"===typeof d&&b.window!==b){if(d)for(var c=0;c<d;c++)a[a.length++]=b[c]}else a[a.length++]=b}}function ed(a,b){return Gb(a,"$"+(b||"ngController")+"Controller")}function Gb(a,b,d){9===a.nodeType&&(a=a.documentElement);for(b=K(b)?b:[b];a;){for(var c=0,e=b.length;c<e;c++)if(u(d=C.data(a,b[c])))return d;a=a.parentNode||11===a.nodeType&&a.host}}function fd(a){for(zb(a,
!0);a.firstChild;)a.removeChild(a.firstChild)}function Hb(a,b){b||zb(a);(b=a.parentNode)&&b.removeChild(a)}function Je(a,b){b=b||G;if("complete"===b.document.readyState)b.setTimeout(a);else C(b).on("load",a)}function cd(a){function b(){G.document.removeEventListener("DOMContentLoaded",b);G.removeEventListener("load",b);a()}"complete"===G.document.readyState?G.setTimeout(a):(G.document.addEventListener("DOMContentLoaded",b),G.addEventListener("load",b))}function gd(a,b){return(b=Ib[b.toLowerCase()])&&
...
z(a)?b.push(t.invoke(a)):K(a)?b.push(t.invoke(a)):xb(a,"module")}catch(E){throw K(a)&&(a=a[a.length-1]),E.message&&E.stack&&-1===E.stack.indexOf(E.message)&&(E=E.message+"\n"+E.stack),ua("modulerr",a,E.stack||E.message||E);}}});return b}function h(a,c){function d(b,d){if(a.hasOwnProperty(b)){if(a[b]===k)throw ua("cdep",b+" <- "+l.join(" <- "));return a[b]}try{return l.unshift(b),a[b]=k,a[b]=c(b,d),a[b]}catch(A){throw a[b]===k&&delete a[b],A;}finally{l.shift()}}function e(a,c,e){var f=[];a=hb.$$annotate(a,
...
0===M)for(;v.length;)try{v.pop()()}catch(N){d.error(N)}}}function f(){L=null;h()}function g(){w=E();w=x(w)?null:w;va(w,B)&&(w=B);O=B=w}function h(){var a=O;g();if(P!==k.url()||a!==w)P=k.url(),O=w,q(A,function(a){a(k.url(),w)})}var k=this,l=a.location,p=a.history,m=a.setTimeout,t=a.clearTimeout,n={};k.isMock=!1;var M=0,v=[];k.$$completeOutstandingRequest=e;k.$$incOutstandingRequestCount=function(){M++};k.notifyWhenNoOutstandingRequests=function(a){0===M?a():v.push(a)};var w,O,P=l.href,y=b.find("base"),
L=null,E=c.history?function(){try{return p.state}catch(I){}}:D;g();k.url=function(b,d,e){x(e)&&(e=null);l!==a.location&&(l=a.location);p!==a.history&&(p=a.history);if(b){var f=O===e;if(P===b&&(!c.history||f))return k;var h=P&&Ea(P)===Ea(b);P=b;O=e;!c.history||h&&f?(h||(L=b),d?l.replace(b):h?(d=l,e=b.indexOf("#"),e=-1===e?"":b.substr(e),d.hash=e):l.href=b,l.href!==b&&(L=b)):(p[d?"replaceState":"pushState"](e,"",b),g());L&&(L=b);return k}return L||l.href.replace(/%27/g,"'")};k.state=function(){return w};
var A=[],ia=!1,B=null;k.onUrlChange=function(b){if(!ia){if(c.history)C(a).on("popstate",f);C(a).on("hashchange",f);ia=!0}A.push(b);return b};k.$$applicationDestroyed=function(){C(a).off("hashchange popstate",f)};k.$$checkUrlChange=h;k.baseHref=function(){var a=y.attr("href");return a?a.replace(/^(https?:)?\/\/[^/]*/,""):""};k.defer=function(a,b){M++;var c=m(function(){delete n[c];e(a)},b||0);n[c]=!0;return c};k.defer.cancel=function(a){return n[a]?(delete n[a],t(a),e(D),!0):!1}}function We(){this.$get=
...
M};var v=!0;this.commentDirectivesEnabled=function(a){return arguments.length?(v=a,this):v};var w=!0;this.cssClassDirectivesEnabled=function(a){return arguments.length?(w=a,this):w};this.$get=["$injector","$interpolate","$exceptionHandler","$templateRequest","$parse","$controller","$rootScope","$sce","$animate","$$sanitizeUri",function(a,b,c,e,A,m,B,I,N,Y){function E(){try{if(!--Ga)throw na=void 0,ka("infchng",M);B.$apply(function(){for(var a=[],b=0,c=na.length;b<c;++b)try{na[b]()}catch(Ra){a.push(Ra)}na=
void 0;if(a.length)throw a;})}finally{Ga++}}function ia(a,b){if(b){var c=Object.keys(b),d;var e=0;for(d=c.length;e<d;e++){var f=c[e];this[f]=b[f]}}else this.$attr={};this.$$element=a}function y(a,b,c){Ea.innerHTML="<span "+b+">";b=Ea.firstChild.attributes;var d=b[0];b.removeNamedItem(d.name);d.value=c;a.attributes.setNamedItem(d)}function P(a,b){try{a.addClass(b)}catch(lb){}}function r(a,b,c,d,e){a instanceof C||(a=C(a));var f=L(a,b,a,c,d,e);r.$$addScopeClass(a);var g=null;return function(b,c,d){if(!a)throw ka("multilink");
ib(b,"scope");e&&e.needsNewScope&&(b=b.$parent.$new());d=d||{};var h=d.parentBoundTranscludeFn,k=d.transcludeControllers;d=d.futureParentElement;h&&h.$$boundTransclude&&(h=h.$$boundTransclude);g||(g=(d=d&&d[0])?"foreignobject"!==Aa(d)&&qa.call(d).match(/SVG/)?"svg":"html":"html");d="html"!==g?C(sa(g,C("<div>").append(a).html())):c?Va.clone.call(a):a;if(k)for(var l in k)d.data("$"+l+"Controller",k[l].instance);r.$$addScopeInfo(d,b);c&&c(d,b);f&&f(b,d,d,h);c||(a=f=null);return d}}function L(a,b,c,d,
e,f){function g(a,c,d,e){var f,g;if(p){var k=Array(c.length);for(f=0;f<h.length;f+=3){var l=h[f];k[l]=c[l]}}else k=c;f=0;for(g=h.length;f<g;){var A=k[h[f++]];c=h[f++];l=h[f++];if(c){if(c.scope){var m=a.$new();r.$$addScopeInfo(C(A),m)}else m=a;var t=c.transcludeOnThisElement?nb(a,c.transclude,e):!c.templateOnThisElement&&e?e:!e&&b?nb(a,b):null;c(l,m,A,d,t)}else l&&l(a,A.childNodes,void 0,e)}}for(var h=[],k=K(a)||a instanceof C,l,A,m,t,p,n=0;n<a.length;n++){l=new ia;11===Ka&&Ua(a,n,k);A=pc(a[n],[],
l,0===n?d:void 0,e);(f=A.length?ca(A,a[n],l,b,c,null,[],[],f):null)&&f.scope&&r.$$addScopeClass(l.$$element);l=f&&f.terminal||!(m=a[n].childNodes)||!m.length?null:L(m,f?(f.transcludeOnThisElement||!f.templateOnThisElement)&&f.transclude:b);if(f||l)h.push(n,f,l),t=!0,p=p||f;f=null}return t?g:null}function Ua(a,b,c){var d=a[b],e=d.parentNode;if(d.nodeType===Qa)for(;;){var f=e?d.nextSibling:a[b+1];if(!f||f.nodeType!==Qa)break;d.nodeValue+=f.nodeValue;f.parentNode&&f.parentNode.removeChild(f);c&&f===
a[b+1]&&a.splice(b+1,1)}}function nb(a,b,c){function d(d,e,f,g,h){d||(d=a.$new(!1,h),d.$$transcluded=!0);return b(d,e,{parentBoundTranscludeFn:c,transcludeControllers:f,futureParentElement:g})}var e=d.$$slots=V(),f;for(f in b.$$slots)e[f]=b.$$slots[f]?nb(a,b.$$slots[f],c):null;return d}function pc(a,b,c,d,e){var f=c.$attr;switch(a.nodeType){case 1:var g=Aa(a);da(b,Fa(g),"E",d,e);for(var k,l,A,m,t=a.attributes,p=0,n=t&&t.length;p<n;p++){var E=!1,B=!1;k=t[p];l=k.name;A=k.value;k=Fa(l);(m=Sa.test(k))&&
(l=l.replace(ld,"").substr(8).replace(/_(.)/g,function(a,b){return b.toUpperCase()}));(k=k.match(Ta))&&ma(k[1])&&(E=l,B=l.substr(0,l.length-5)+"end",l=l.substr(0,l.length-6));k=Fa(l.toLowerCase());f[k]=l;if(m||!c.hasOwnProperty(k))c[k]=A,gd(a,k)&&(c[k]=!0);Ba(a,b,A,k,m);da(b,k,"A",d,e,E,B)}"input"===g&&"hidden"===a.getAttribute("type")&&a.setAttribute("autocomplete","off");if(!Oa)break;f=a.className;H(f)&&(f=f.animVal);if(J(f)&&""!==f)for(;a=h.exec(f);)k=Fa(a[2]),da(b,k,"C",d,e)&&(c[k]=U(a[3])),f=
f.substr(a.index+a[0].length);break;case Qa:ta(b,a.nodeValue);break;case 8:Na&&R(a,b,c,d,e)}b.sort(pa);return b}function R(a,b,c,d,e){try{var f=g.exec(a.nodeValue);if(f){var h=Fa(f[1]);da(b,h,"M",d,e)&&(c[h]=U(f[2]))}}catch(Lb){}}function md(a,b,c){var d=[],e=0;if(b&&a.hasAttribute&&a.hasAttribute(b)){do{if(!a)throw ka("uterdir",b,c);1===a.nodeType&&(a.hasAttribute(b)&&e++,a.hasAttribute(c)&&e--);d.push(a);a=a.nextSibling}while(0<e)}else d.push(a);return C(d)}function X(a,b,c){return function(d,e,
f,g,h){e=md(e[0],b,c);return a(d,e,f,g,h)}}function Z(a,b,c,d,e,f){var g;return a?r(b,c,d,e,f):function(){g||(g=r(b,c,d,e,f),b=c=f=null);return g.apply(this,arguments)}}function ca(a,b,d,e,f,g,h,k,l){function A(a,b,c,d){if(a){c&&(a=X(a,c,d));a.require=F.require;a.directiveName=y;if(B===F||F.$$isolateScope)a=wa(a,{isolateScope:!0});h.push(a)}if(b){c&&(b=X(b,c,d));b.require=F.require;b.directiveName=y;if(B===F||F.$$isolateScope)b=wa(b,{isolateScope:!0});k.push(b)}}function m(a,e,f,g,l){function A(a,
b,c,d){var e;bb(a)||(d=c,c=b,b=a,a=void 0);M&&(e=m);c||(c=M?t.parent():t);if(d){var f=l.$$slots[d];if(f)return f(a,b,e,c,ja);if(x(f))throw ka("noslot",d,Da(t));}else return l(a,b,e,c,ja)}var m;if(b===f){g=d;var t=d.$$element}else t=C(f),g=new ia(t,d);var F=e;if(B)var w=e.$new(!0);else p&&(F=e.$parent);if(l){var W=A;W.$$boundTransclude=l;W.isSlotFilled=function(a){return!!l.$$slots[a]}}E&&(m=fa(t,g,W,E,w,e,B));if(B){r.$$addScopeInfo(t,w,!0,!(N&&(N===B||N===B.$$originalDirective)));r.$$addScopeClass(t,
!0);w.$$isolateBindings=B.$$isolateBindings;var v=ua(e,g,w,w.$$isolateBindings,B);v.removeWatches&&w.$on("$destroy",v.removeWatches)}for(Y in m){v=E[Y];var I=m[Y];var y=v.$$bindings.bindToController;if(n){I.bindingInfo=y?ua(F,g,I.instance,y,v):{};var P=I();P!==I.instance&&(I.instance=P,t.data("$"+v.name+"Controller",P),I.bindingInfo.removeWatches&&I.bindingInfo.removeWatches(),I.bindingInfo=ua(F,g,I.instance,y,v))}else I.instance=I(),t.data("$"+v.name+"Controller",I.instance),I.bindingInfo=ua(F,g,
I.instance,y,v)}q(E,function(a,b){var c=a.require;a.bindToController&&!K(c)&&H(c)&&T(m[b].instance,aa(b,c,t,m))});q(m,function(a){var b=a.instance;if(z(b.$onChanges))try{b.$onChanges(a.bindingInfo.initialChanges)}catch(qc){c(qc)}if(z(b.$onInit))try{b.$onInit()}catch(qc){c(qc)}z(b.$doCheck)&&(F.$watch(function(){b.$doCheck()}),b.$doCheck());z(b.$onDestroy)&&F.$on("$destroy",function(){b.$onDestroy()})});var Y=0;for(v=h.length;Y<v;Y++)I=h[Y],Ca(I,I.isolateScope?w:e,t,g,I.require&&aa(I.directiveName,
I.require,t,m),W);var ja=e;B&&(B.template||null===B.templateUrl)&&(ja=w);a&&a(ja,f.childNodes,void 0,l);for(Y=k.length-1;0<=Y;Y--)I=k[Y],Ca(I,I.isolateScope?w:e,t,g,I.require&&aa(I.directiveName,I.require,t,m),W);q(m,function(a){a=a.instance;z(a.$postLink)&&a.$postLink()})}l=l||{};for(var t=-Number.MAX_VALUE,p=l.newScopeDirective,E=l.controllerDirectives,B=l.newIsolateScopeDirective,N=l.templateDirective,w=l.nonTlbTranscludeDirective,v=!1,I=!1,M=l.hasElementTranscludeDirective,W=d.$$element=C(b),
F,y,P,Y=e,ja,L=!1,lb=!1,Q,u=0,Ra=a.length;u<Ra;u++){F=a[u];var ba=F.$$start,oc=F.$$end;ba&&(W=md(b,ba,oc));P=void 0;if(t>F.priority)break;if(Q=F.scope)F.templateUrl||(H(Q)?(ea("new/isolated scope",B||p,F,W),B=F):ea("new/isolated scope",B,F,W)),p=p||F;y=F.name;if(!L&&(F.replace&&(F.templateUrl||F.template)||F.transclude&&!F.$$tlb)){for(Q=u+1;L=a[Q++];)if(L.transclude&&!L.$$tlb||L.replace&&(L.templateUrl||L.template)){lb=!0;break}L=!0}!F.templateUrl&&F.controller&&(E=E||V(),ea("'"+y+"' controller",
E[y],F,W),E[y]=F);if(Q=F.transclude)if(v=!0,F.$$tlb||(ea("transclusion",w,F,W),w=F),"element"===Q)M=!0,t=F.priority,P=W,W=d.$$element=C(r.$$createComment(y,d[y])),b=W[0],ra(f,za.call(P,0),b),P[0].$$parentNode=P[0].parentNode,Y=Z(lb,P,e,t,g&&g.name,{nonTlbTranscludeDirective:w});else{var Ma=V();if(H(Q)){P=[];var Kb=V(),Lb=V();q(Q,function(a,b){var c="?"===a.charAt(0);a=c?a.substring(1):a;Kb[a]=b;Ma[b]=null;Lb[b]=c});q(W.contents(),function(a){var b=Kb[Fa(Aa(a))];b?(Lb[b]=!0,Ma[b]=Ma[b]||[],Ma[b].push(a)):
P.push(a)});q(Lb,function(a,b){if(!a)throw ka("reqslot",b);});for(var G in Ma)Ma[G]&&(Ma[G]=Z(lb,Ma[G],e))}else P=C(kc(b)).contents();W.empty();Y=Z(lb,P,e,void 0,void 0,{needsNewScope:F.$$isolateScope||F.$$newScope});Y.$$slots=Ma}if(F.template)if(I=!0,ea("template",N,F,W),N=F,Q=z(F.template)?F.template(W,d):F.template,Q=Ja(Q),F.replace){g=F;P=hc.test(Q)?nd(sa(F.templateNamespace,U(Q))):[];b=P[0];if(1!==P.length||1!==b.nodeType)throw ka("tplrt",y,"");ra(f,W,b);Ra={$attr:{}};Q=pc(b,[],Ra);var D=a.splice(u+
1,a.length-(u+1));(B||p)&&ha(Q,B,p);a=a.concat(Q).concat(D);la(d,Ra);Ra=a.length}else W.html(Q);if(F.templateUrl)I=!0,ea("template",N,F,W),N=F,F.replace&&(g=F),m=oa(a.splice(u,a.length-u),W,d,f,v&&Y,h,k,{controllerDirectives:E,newScopeDirective:p!==F&&p,newIsolateScopeDirective:B,templateDirective:N,nonTlbTranscludeDirective:w}),Ra=a.length;else if(F.compile)try{ja=F.compile(W,d,Y);var mb=F.$$originalDirective||F;z(ja)?A(null,eb(mb,ja),ba,oc):ja&&A(eb(mb,ja.pre),eb(mb,ja.post),ba,oc)}catch(bf){c(bf,
Da(W))}F.terminal&&(m.terminal=!0,t=Math.max(t,F.priority))}m.scope=p&&!0===p.scope;m.transcludeOnThisElement=v;m.templateOnThisElement=I;m.transclude=Y;l.hasElementTranscludeDirective=M;return m}function aa(a,b,c,d){if(J(b)){var e=b.match(l);b=b.substring(e[0].length);var f=e[1]||e[3];e="?"===e[2];if("^^"===f)c=c.parent();else var g=(g=d&&d[b])&&g.instance;if(!g){var h="$"+b+"Controller";g=f?c.inheritedData(h):c.data(h)}if(!g&&!e)throw ka("ctreq",b,a);}else if(K(b))for(g=[],f=0,e=b.length;f<e;f++)g[f]=
aa(a,b[f],c,d);else H(b)&&(g={},q(b,function(b,e){g[e]=aa(a,b,c,d)}));return g||null}function fa(a,b,c,d,e,f,g){var h=V(),k;for(k in d){var l=d[k],A={$scope:l===g||l.$$isolateScope?e:f,$element:a,$attrs:b,$transclude:c},t=l.controller;"@"===t&&(t=b[l.name]);A=m(t,A,!0,l.controllerAs);h[l.name]=A;a.data("$"+l.name+"Controller",A.instance)}return h}function ha(a,b,c){for(var d=0,e=a.length;d<e;d++)a[d]=ac(a[d],{$$isolateScope:b,$$newScope:c})}function da(b,c,e,g,h,k,l){if(c===h)return null;var A=null;
if(f.hasOwnProperty(c)){h=a.get(c+"Directive");for(var m=0,t=h.length;m<t;m++)if(c=h[m],(x(g)||g>c.priority)&&-1!==c.restrict.indexOf(e)){k&&(c=ac(c,{$$start:k,$$end:l}));if(!c.$$bindings){var p=A=c,n=c.name,B={isolateScope:null,bindToController:null};H(p.scope)&&(!0===p.bindToController?(B.bindToController=d(p.scope,n,!0),B.isolateScope={}):B.isolateScope=d(p.scope,n,!1));H(p.bindToController)&&(B.bindToController=d(p.bindToController,n,!0));if(B.bindToController&&!p.controller)throw ka("noctrl",
n);A=A.$$bindings=B;H(A.isolateScope)&&(c.$$isolateBindings=A.isolateScope)}b.push(c);A=c}}return A}function ma(b){if(f.hasOwnProperty(b))for(var c=a.get(b+"Directive"),d=0,e=c.length;d<e;d++)if(b=c[d],b.multiElement)return!0;return!1}function la(a,b){var c=b.$attr,d=a.$attr;q(a,function(d,e){"$"!==e.charAt(0)&&(b[e]&&b[e]!==d&&(d=d.length?d+(("style"===e?";":" ")+b[e]):b[e]),a.$set(e,d,!0,c[e]))});q(b,function(b,e){a.hasOwnProperty(e)||"$"===e.charAt(0)||(a[e]=b,"class"!==e&&"style"!==e&&(d[e]=c[e]))})}
function oa(a,b,d,f,g,h,k,l){var A=[],m,t,p=b[0],n=a.shift(),B=ac(n,{templateUrl:null,transclude:null,replace:null,$$originalDirective:n}),E=z(n.templateUrl)?n.templateUrl(b,d):n.templateUrl,I=n.templateNamespace;b.empty();e(E).then(function(c){c=Ja(c);if(n.replace){c=hc.test(c)?nd(sa(I,U(c))):[];var e=c[0];if(1!==c.length||1!==e.nodeType)throw ka("tplrt",n.name,E);c={$attr:{}};ra(f,b,e);var N=pc(e,[],c);H(n.scope)&&ha(N,!0);a=N.concat(a);la(d,c)}else e=p,b.html(c);a.unshift(B);m=ca(a,e,d,g,b,n,h,
k,l);q(f,function(a,c){a===e&&(f[c]=b[0])});for(t=L(b[0].childNodes,g);A.length;){c=A.shift();var w=A.shift();var ia=A.shift(),v=A.shift();N=b[0];if(!c.$$destroyed){if(w!==p){var M=w.className;l.hasElementTranscludeDirective&&n.replace||(N=kc(e));ra(ia,C(w),N);P(C(N),M)}w=m.transcludeOnThisElement?nb(c,m.transclude,v):v;m(t,c,N,f,w)}}A=null}).catch(function(a){a instanceof Error&&c(a)});return function(a,b,c,d,e){a=e;b.$$destroyed||(A?A.push(b,c,d,a):(m.transcludeOnThisElement&&(a=nb(b,m.transclude,
...
b.length,f=d.parentNode,g;if(a){var h=0;for(g=a.length;h<g;h++)if(a[h]===d){a[h++]=c;g=h+e-1;for(var k=a.length;h<k;h++,g++)g<k?a[h]=a[g]:delete a[h];a.length-=e-1;a.context===d&&(a.context=c);break}}f&&f.replaceChild(c,d);a=G.document.createDocumentFragment();for(h=0;h<e;h++)a.appendChild(b[h]);C.hasData(d)&&(C.data(c,C.data(d)),C(d).off("$destroy"));C.cleanData(a.querySelectorAll("*"));for(h=1;h<e;h++)delete b[h];b[0]=c;b.length=1}function wa(a,b){return T(function(){return a.apply(null,arguments)},
a,b)}function Ca(a,b,d,e,f,g){try{a(b,d,e,f,g)}catch($e){c($e,Da(d))}}function ua(a,c,d,e,f){function g(b,c,e){z(d.$onChanges)&&!cc(c,e)&&(na||(a.$$postDigest(E),na=[]),m||(m={},na.push(h)),m[b]&&(e=m[b].previousValue),m[b]=new Mb(e,c))}function h(){d.$onChanges(m);m=void 0}var k=[],l={},m;q(e,function(e,h){var m=e.attrName,t=e.optional;switch(e.mode){case "@":t||ya.call(c,m)||(d[h]=c[m]=void 0);e=c.$observe(m,function(a){if(J(a)||Pa(a))g(h,a,d[h]),d[h]=a});c.$$observers[m].$$scope=a;var p=c[m];J(p)?
d[h]=b(p)(a):Pa(p)&&(d[h]=p);l[h]=new Mb(rc,d[h]);k.push(e);break;case "=":if(!ya.call(c,m)){if(t)break;c[m]=void 0}if(t&&!c[m])break;var n=A(c[m]);var B=n.literal?va:cc;var E=n.assign||function(){p=d[h]=n(a);throw ka("nonassign",c[m],m,f.name);};p=d[h]=n(a);t=function(b){B(b,d[h])||(B(b,p)?E(a,b=d[h]):d[h]=b);return p=b};t.$stateful=!0;e=e.collection?a.$watchCollection(c[m],t):a.$watch(A(c[m],t),null,n.literal);k.push(e);break;case "<":if(!ya.call(c,m)){if(t)break;c[m]=void 0}if(t&&!c[m])break;n=
A(c[m]);var I=n.literal,N=d[h]=n(a);l[h]=new Mb(rc,d[h]);e=a.$watch(n,function(a,b){if(b===a){if(b===N||I&&va(b,N))return;b=N}g(h,a,b);d[h]=a},I);k.push(e);break;case "&":n=c.hasOwnProperty(m)?A(c[m]):D,n===D&&t||(d[h]=function(b){return n(a,b)})}});return{initialChanges:l,removeWatches:k.length&&function(){for(var a=0,b=k.length;a<b;++a)k[a]()}}}var La=/^\w/,Ea=G.document.createElement("div"),Na=v,Oa=w,Ga=M,na;ia.prototype={$normalize:Fa,$addClass:function(a){a&&0<a.length&&N.addClass(this.$$element,
...
$observe:function(a,b){var c=this,d=c.$$observers||(c.$$observers=V()),e=d[a]||(d[a]=[]);e.push(b);B.$evalAsync(function(){e.$$inter||!c.hasOwnProperty(a)||x(c[a])||b(c[a])});return function(){cb(e,b)}}};var Ha=b.startSymbol(),Ia=b.endSymbol(),Ja="{{"===Ha&&"}}"===Ia?wb:function(a){return a.replace(/\{\{/g,Ha).replace(/}}/g,Ia)},Sa=/^ngAttr[A-Z]/,Ta=/^(.+)Start$/;r.$$addBindingInfo=t?function(a,b){var c=a.data("$binding")||[];K(b)?c=c.concat(b):c.push(b);a.data("$binding",c)}:D;r.$$addBindingClass=
t?function(a){P(a,"ng-binding")}:D;r.$$addScopeInfo=t?function(a,b,c,d){a.data(c?d?"$isolateScopeNoTemplate":"$isolateScope":"$scope",b)}:D;r.$$addScopeClass=t?function(a,b){P(a,b?"ng-isolate-scope":"ng-scope")}:D;r.$$createComment=function(a,b){var c="";t&&(c=" "+(a||"")+": ",b&&(c+=b+" "));return G.document.createComment(c)};return r}]}function Mb(a,b){this.previousValue=a;this.currentValue=b}function Fa(a){return a.replace(ld,"").replace(cf,ra)}function od(a,b){var d="";a=a.split(/\s+/);b=b.split(/\s+/);
var c=0;a:for(;c<a.length;c++){for(var e=a[c],f=0;f<b.length;f++)if(e===b[f])continue a;d+=(0<d.length?" ":"")+e}return d}function nd(a){a=C(a);var b=a.length;if(1>=b)return a;for(;b--;){var d=a[b];(8===d.nodeType||d.nodeType===Qa&&""===d.nodeValue.trim())&&df.call(a,b,1)}return a}function Ze(a,b){if(b&&J(b))return b;if(J(a)&&(a=qd.exec(a)))return a[3]}function ef(){var a={},b=!1;this.has=function(b){return a.hasOwnProperty(b)};this.register=function(b,c){Ia(b,"controller");H(b)?T(a,b):a[b]=c};this.allowGlobals=
...
d.invoke(f,m,g,p);a!==m&&(H(a)||z(a))&&(m=a,l&&e(g,l,m,p||f.name));return m},{instance:m,identifier:l})}m=d.instantiate(f,g,p);l&&e(g,l,m,p||f.name);return m}}]}function ff(){this.$get=["$window",function(a){return C(a.document)}]}function gf(){this.$get=["$document","$rootScope",function(a,b){function d(){e=c.hidden}var c=a[0],e=c&&c.hidden;a.on("visibilitychange",d);b.$on("$destroy",function(){a.off("visibilitychange",d)});return function(){return e}}]}function hf(){this.$get=["$log",function(a){return function(b,
...
(200<=a&&300>a?N.put(Q,[a,c,td(d),e]):N.remove(Q));b?h.$applyAsync(f):(f(),h.$$phase||h.$apply())}function t(a,b,d,e){b=-1<=b?b:0;(200<=b&&300>b?O.resolve:O.reject)({data:a,status:b,headers:ud(d),config:c,statusText:e})}function A(a){t(a.data,a.status,ta(a.headers()),a.statusText)}function w(){var a=m.pendingRequests.indexOf(c);-1!==a&&m.pendingRequests.splice(a,1)}var O=k.defer(),I=O.promise,N,P=c.headers,r="jsonp"===S(c.method),Q=c.url;r?Q=p.getTrustedResourceUrl(Q):J(Q)||(Q=p.valueOf(Q));Q=n(Q,
c.paramSerializer(c.params));r&&(Q=M(Q,c.jsonpCallbackParam));m.pendingRequests.push(c);I.then(w,w);!c.cache&&!a.cache||!1===c.cache||"GET"!==c.method&&"JSONP"!==c.method||(N=H(c.cache)?c.cache:H(a.cache)?a.cache:v);if(N){var ba=N.get(Q);u(ba)?ba&&z(ba.then)?ba.then(A,A):K(ba)?t(ba[1],ba[0],ta(ba[2]),ba[3]):t(ba,200,{},"OK"):N.put(Q,I)}x(ba)&&((ba=wd(c.url)?f()[c.xsrfCookieName||a.xsrfCookieName]:void 0)&&(P[c.xsrfHeaderName||a.xsrfHeaderName]=ba),e(c.method,Q,d,l,P,c.timeout,c.withCredentials,c.responseType,
...
p,m,t,n,M,v){function g(){P&&P();y&&y.abort()}h=h||a.url();if("jsonp"===S(e))var O=c.createCallback(h),P=f(h,O,function(a,b){var e=200===a&&c.getResponse(O);u(r)&&d.cancel(r);P=y=null;l(a,e,"",b);c.removeCallback(O)});else{var y=b(e,h);y.open(e,h,!0);q(p,function(a,b){u(a)&&y.setRequestHeader(b,a)});y.onload=function(){var a=y.statusText||"",b="response"in y?y.response:y.responseText,c=1223===y.status?204:y.status;0===c&&(c=b?200:"file"===Na(h).protocol?404:0);var e=y.getAllResponseHeaders();u(r)&&
d.cancel(r);P=y=null;l(c,b,e,a)};e=function(){u(r)&&d.cancel(r);P=y=null;l(-1,null,null,"")};y.onerror=e;y.onabort=e;y.ontimeout=e;q(M,function(a,b){y.addEventListener(b,a)});q(v,function(a,b){y.upload.addEventListener(b,a)});t&&(y.withCredentials=!0);if(n)try{y.responseType=n}catch(E){if("json"!==n)throw E;}y.send(x(k)?null:k)}if(0<m)var r=d(g,m);else m&&z(m.then)&&m.then(g)}}function sf(){var a="{{",b="}}";this.startSymbol=function(b){return b?(a=b,this):a};this.endSymbol=function(a){return a?(b=
a,this):b};this.$get=["$parse","$exceptionHandler","$sce",function(d,c,e){function f(a){return"\\\\\\"+a}function g(c){return c.replace(m,a).replace(t,b)}function h(a,b,c,d){var e=a.$watch(function(a){e();return d(a)},b,c);return e}function k(f,k,m,t){function n(a){try{var b=a;a=m?e.getTrusted(m,b):e.valueOf(b);return t&&!u(a)?a:fc(a)}catch(Q){c(Oa.interr(f,Q))}}if(!f.length||-1===f.indexOf(a)){if(!k){k=g(f);var w=pa(k);w.exp=f;w.expressions=[];w.$$watchDelegate=h}return w}t=!!t;var v,M,E=0,A=[],
ia=[];w=f.length;for(var B=[],I=[];E<w;)if(-1!==(v=f.indexOf(a,E))&&-1!==(M=f.indexOf(b,v+l)))E!==v&&B.push(g(f.substring(E,v))),E=f.substring(v+l,M),A.push(E),ia.push(d(E,n)),E=M+p,I.push(B.length),B.push("");else{E!==w&&B.push(g(f.substring(E)));break}m&&1<B.length&&Oa.throwNoconcat(f);if(!k||A.length){var N=function(a){for(var b=0,c=A.length;b<c;b++){if(t&&x(a[b]))return;B[I[b]]=a[b]}return B.join("")};return T(function(a){var b=0,d=A.length,e=Array(d);try{for(;b<d;b++)e[b]=ia[b](a);return N(e)}catch(Kb){c(Oa.interr(f,
Kb))}},{exp:f,expressions:A,$$watchDelegate:function(a,b){var c;return a.$watchGroup(ia,function(d,e){var f=N(d);z(b)&&b.call(this,f,d!==e?c:f,a);c=f})}})}}var l=a.length,p=b.length,m=new RegExp(a.replace(/./g,f),"g"),t=new RegExp(b.replace(/./g,f),"g");k.startSymbol=function(){return a};k.endSymbol=function(){return b};return k}]}function tf(){this.$get=["$rootScope","$window","$q","$$q","$browser",function(a,b,d,c,e){function f(f,k,l,p){function h(){t?f.apply(null,n):f(w)}var t=4<arguments.length,
...
{};this.$$listenerCount={};this.$$watchersCount=0;this.$$isolateBindings=null}function m(a){if(O.$$phase)throw d("inprog",O.$$phase);O.$$phase=a}function t(a,b){do a.$$watchersCount+=b;while(a=a.$parent)}function n(a,b,c){do a.$$listenerCount[c]-=b,0===a.$$listenerCount[c]&&delete a.$$listenerCount[c];while(a=a.$parent)}function r(){}function v(){for(;L.length;)try{L.shift()()}catch(A){f(A)}e=null}function w(){null===e&&(e=h.defer(function(){O.$apply(v)}))}p.prototype={constructor:p,$new:function(b,
...
q.$$watchersCount&&q.$$childHead||q!==this&&q.$$nextSibling))for(;q!==this&&!(l=q.$$nextSibling);)q=q.$parent}while(q=l);if((n||u.length)&&!p--)throw O.$$phase=null,d("infdig",b,t);}while(n||u.length);for(O.$$phase=null;E<y.length;)try{y[E++]()}catch(Ua){f(Ua)}y.length=E=0;h.$$checkUrlChange()},$destroy:function(){if(!this.$$destroyed){var a=this.$parent;this.$broadcast("$destroy");this.$$destroyed=!0;this===O&&h.$$applicationDestroyed();t(this,-this.$$watchersCount);for(var b in this.$$listenerCount)n(this,
...
b)},$evalAsync:function(a,b){O.$$phase||u.length||h.defer(function(){u.length&&O.$digest()});u.push({scope:this,fn:g(a),locals:b})},$$postDigest:function(a){y.push(a)},$apply:function(a){try{m("$apply");try{return this.$eval(a)}finally{O.$$phase=null}}catch(ia){f(ia)}finally{try{O.$digest()}catch(ia){throw f(ia),ia;}}},$applyAsync:function(a){function b(){c.$eval(a)}var c=this;a&&L.push(b);a=g(a);w()},$on:function(a,b){var c=this.$$listeners[a];c||(this.$$listeners[a]=c=[]);c.push(b);var d=this;do d.$$listenerCount[a]||
...
var r,v={$id:Ja};if(m)var u=a(m);else{var x=function(a,b){return Ja(b)};var C=function(a){return a}}return function(a,d,f,g,m){u&&(r=function(b,c,d){n&&(v[n]=b);v[t]=c;v.$index=d;return u(a,v)});var w=V();a.$watchCollection(l,function(f){var g,l=d[0],u=V();p&&(a[p]=f);if(xa(f)){var v=f;var y=r||x}else for(A in y=r||C,v=[],f)ya.call(f,A)&&"$"!==A.charAt(0)&&v.push(A);var z=v.length;var A=Array(z);for(g=0;g<z;g++){var E=f===v?g:v[g];var G=f[E];var D=y(E,G,g);if(w[D]){var B=w[D];delete w[D];u[D]=B;A[g]=
B}else{if(u[D])throw q(A,function(a){a&&a.scope&&(w[a.id]=a)}),c("dupes",h,D,G);A[g]={id:D,scope:void 0,clone:void 0};u[D]=!0}}for(H in w){B=w[H];D=yb(B.clone);b.leave(D);if(D[0].parentNode)for(g=0,y=D.length;g<y;g++)D[g].$$NG_REMOVED=!0;B.scope.$destroy()}for(g=0;g<z;g++)if(E=f===v?g:v[g],G=f[E],B=A[g],B.scope){var H=l;do H=H.nextSibling;while(H&&H.$$NG_REMOVED);B.clone[0]!==H&&b.move(yb(B.clone),null,l);l=B.clone[B.clone.length-1];e(B.scope,g,t,G,n,E,z)}else m(function(a,c){B.scope=c;c=k.cloneNode(!1);
a[a.length++]=c;b.enter(a,null,l);l=c;B.clone=a;u[B.id]=B;e(B.scope,g,t,G,n,E,z)});w=u})}}}}],bh=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(b,d,c){b.$watch(c.ngShow,function(b){a[b?"removeClass":"addClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],ch=["$animate",function(a){return{restrict:"A",multiElement:!0,link:function(b,d,c){b.$watch(c.ngHide,function(b){a[b?"addClass":"removeClass"](d,"ng-hide",{tempClasses:"ng-hide-animate"})})}}}],dh=Sa(function(a,
...
e.ngModelCtrl.$render()}))}function c(a){h||(h=!0,b.$$postDigest(function(){b.$$destroyed||(h=!1,e.ngModelCtrl.$setViewValue(e.readValue()),a&&e.ngModelCtrl.$render())}))}var e=this,f=new Jb;e.selectValueMap={};e.ngModelCtrl=kh;e.multiple=!1;e.unknownOption=C(G.document.createElement("option"));e.hasEmptyOption=!1;e.emptyOption=void 0;e.renderUnknownOption=function(b){b=e.generateUnknownOptionValue(b);e.unknownOption.val(b);a.prepend(e.unknownOption);Xa(e.unknownOption,!0);a.val(b)};e.updateUnknownOption=
...
a.val();b=b in e.selectValueMap?e.selectValueMap[b]:b;return e.hasOption(b)?b:null};e.writeValue=function(b){var c=a[0].options[a[0].selectedIndex];c&&Xa(C(c),!1);e.hasOption(b)?(e.removeUnknownOption(),c=Ja(b),a.val(c in e.selectValueMap?c:b),Xa(C(a[0].options[a[0].selectedIndex]),!0)):null==b&&e.emptyOption?(e.removeUnknownOption(),e.selectEmptyOption()):e.unknownOption.parent().length?e.updateUnknownOption(b):e.renderUnknownOption(b)};e.addOption=function(a,b){8!==b[0].nodeType&&(Ia(a,'"option value"'),
...
e.selectValueMap[b]:b))});return a};e.writeValue=function(a){q(b.find("option"),function(b){var c=!!a&&(-1!==Array.prototype.indexOf.call(a,b.value)||-1!==Array.prototype.indexOf.call(a,e.selectValueMap[b.value]));c!==b.selected&&Xa(C(b),c)})};var g,h=NaN;a.$watch(function(){h!==f.$viewValue||va(g,f.$viewValue)||(g=ta(f.$viewValue),f.$render());h=f.$viewValue});f.$isEmpty=function(a){return!a||0===a.length}}}else e.registerOption=D},post:function(a,b,d,c){var e=c[1];if(e){var f=c[0];e.$render=function(){f.writeValue(e.$viewValue)}}}}}},
...
Ub();if((wa=x(a)?G.jQuery:a?G[a]:void 0)&&wa.fn.on){C=wa;T(wa.fn,{scope:Va.scope,isolateScope:Va.isolateScope,controller:Va.controller,injector:Va.injector,inheritedData:Va.inheritedData});var b=wa.cleanData;wa.cleanData=function(a){for(var c,d=0,f;null!=(f=a[d]);d++)(c=wa._data(f,"events"))&&c.$destroy&&wa(f).triggerHandler("$destroy");b(a)}}else C=X;ma.element=C;ce=!0}})();(function(a){T(a,{errorHandlingConfig:qe,bootstrap:Zc,copy:Ba,extend:T,merge:se,equals:va,element:C,forEach:q,injector:hb,noop:D,
